...
class check_all_command(commands.Cog):
    def __init__(self, client: commands.Bot):
        self.client = client
        
        @client.tree.context_menu(name = 'Check-all')
        async def check_all_option(interaction: discord.Interaction, message: discord.Message):
...
async def setup(client: commands.Bot):
    await client.add_cog(check_all_command(client))